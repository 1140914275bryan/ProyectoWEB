    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Negocio, VMNegocio>()
                ...
                opt => opt.MapFrom(origen => Convert.ToString(origen.PorcentajeImpuesto.Value, new CultureInfo("es-COL"))));

            CreateMap<VMNegocio, Negocio>()
                .ForMember(destino =>
                destino.PorcentajeImpuesto,
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.PorcentajeImpuesto, new CultureInfo("es-COL"))));
            #endregion Negocio
            ...
            CreateMap<Venta, VMVenta>()
                ...
                opt => opt.MapFrom(origen => origen.IdUsuarioNavigation.Nombre)
                 ...
                 .ForMember(destino =>
                destino.SubTotal,
                opt => opt.MapFrom(origen => Convert.ToString(origen.SubTotal.Value, new CultureInfo("es-COL")))
                )
                  .ForMember(destino =>
                destino.ImpuestoTotal,
                opt => opt.MapFrom(origen => Convert.ToString(origen.ImpuestoTotal.Value, new CultureInfo("es-COL")))
                )
                   .ForMember(destino =>
                destino.Total,
            ...
            CreateMap<VMVenta, Venta>()
                .ForMember(destino =>
                destino.SubTotal,
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.SubTotal, new CultureInfo("es-COL")))
                )
                .ForMember(destino =>
                destino.ImpuestoTotal,
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.ImpuestoTotal, new CultureInfo("es-COL")))
                )
                .ForMember(destino =>
                destino.Total,
            ...
            CreateMap<VMDetalleVenta, DetalleVenta>()
                ...
                .ForMember(destino =>
                destino.Total,
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.Total, new CultureInfo("es-COL")))
                );
            ...
            CreateMap<DetalleVenta, VMReporteVenta>()
                ...
                opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.SubTotal.Value, new CultureInfo("es-COL")))
                )
                .ForMember(destino =>
                destino.ImpuestoTotalVenta,
                opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.ImpuestoTotal.Value, new CultureInfo("es-COL")))
                )
                .ForMember(destino =>
                destino.TotalVenta,
