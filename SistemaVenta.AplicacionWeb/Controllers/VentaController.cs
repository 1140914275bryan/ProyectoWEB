...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    {
        private readonly ITipoDocumentoVentaServicio _tipoDocumentoVentaServicio;
        private readonly IVentaServicio _ventaServicio;
        private readonly IMapper _mapper;
        private readonly IConverter _converter;

        public VentaController(ITipoDocumentoVentaServicio tipoDocumentoVentaServicio,
            IVentaServicio ventaServicio, IMapper mapper, IConverter converter)
        {
        ...
        public async Task<IActionResult> RegistrarVenta([FromBody]VMVenta modelo)
        {
            ...
            try
            {
                ...
                modelo.IdUsuario = int.Parse(idUsuario); // Asigna el ID del usuario autenticado
        ...
        {
            // Corregir la URL: eliminar el espacio y los dos puntos extras
                ...
                Objects =
        {
            ...
            try
            {
                ...
                return File(archivoPDF, "application/pdf", $"Venta_{numeroVenta}.pdf");
            }
            catch (Exception ex)
            {
                // Registrar el error para depurar
