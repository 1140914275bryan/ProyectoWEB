...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class NegocioController : Controller
    {
        ...
        public NegocioController(IMapper mapper, IServicioNegocio servicioNegocio)
        {
            _mapper = mapper;
        ...
        public async Task<IActionResult> Obtener()
        {
            ...
            //devuelve toda la informacion del negocio
            try
            {
                VMNegocio vMNegocio = _mapper.Map<VMNegocio>(await _servicioNegocio.Obtener());
            ...
            public async Task<IActionResult> GuardarCambios([FromForm]IFormFile logo,[FromForm]string modelo)
            {
                ...
                try
                {
                    ...
                    Negocio negocio_editado = await _servicioNegocio.GuardarCambios(_mapper.Map<Negocio>(vMNegocio),
